    ...
    red: [
      {
        ...
        output: '(fail) The server answers which commit it runs > The client reads the commit the server runs',
      },
      {
        ...
        output: '(fail) The server answers which commit it runs > The CLI prints the commit the server runs',
      },
      {
        ...
        output: '(fail) The server answers which commit it runs > A server with no commit set does not start',
      },
    ],
  },
  {
